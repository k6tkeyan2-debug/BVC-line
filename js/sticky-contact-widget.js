...
(function() {
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function onScroll() {
      ...
      // Calculate stop point with better margins for small content
      var stopPoint = Math.max(footerTop - widgetHeight - 100, scrollY);
      
      // Only make sticky if there's enough content below
      var hasEnoughContent = (pageHeight - (scrollY + viewportHeight)) > 200;
      
      if (scrollY + stickyOffset >= origOffset && scrollY < stopPoint && hasEnoughContent) {
